...
public:
  ...
  /**
   * @defgroup stdpmodule_handle Functions handling incoming events.
...
inline nest::port
stdpmodule::pif_psc_alpha::send_test_event( nest::Node& target,
...
inline nest::port
stdpmodule::pif_psc_alpha::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
stdpmodule::pif_psc_alpha::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
stdpmodule::pif_psc_alpha::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
