...
nest::RecordablesMap< stdpmodule::pif_psc_alpha > stdpmodule::pif_psc_alpha::recordablesMap_;
...
template <>
void
RecordablesMap< stdpmodule::pif_psc_alpha >::create()
{
  // use standard names whereever you can for consistency!
  insert_( names::V_m, &stdpmodule::pif_psc_alpha::get_V_m_ );
}
}
...
stdpmodule::pif_psc_alpha::Parameters_::Parameters_()
  : C_m( 250.0 )     // pF
  , I_e( 0.0 )       // nA
  , tau_syn( 2.0 )   // ms
  , V_th( -55.0 )    // mV
...
stdpmodule::pif_psc_alpha::State_::State_( const Parameters_& p )
  : V_m( p.V_reset )
  , dI_syn( 0.0 )
  , I_syn( 0.0 )
  , I_ext( 0.0 )
...
void
stdpmodule::pif_psc_alpha::Parameters_::get( DictionaryDatum& d ) const
{
  ( *d )[ names::C_m ] = C_m;
  ( *d )[ names::I_e ] = I_e;
...
void
stdpmodule::pif_psc_alpha::Parameters_::set( const DictionaryDatum& d )
{
...
void
stdpmodule::pif_psc_alpha::State_::get( DictionaryDatum& d ) const
{
...
void
stdpmodule::pif_psc_alpha::State_::set( const DictionaryDatum& d, const Parameters_& p )
{
...
stdpmodule::pif_psc_alpha::Buffers_::Buffers_( pif_psc_alpha& n )
  : logger_( n )
{
}

stdpmodule::pif_psc_alpha::Buffers_::Buffers_( const Buffers_&, pif_psc_alpha& n )
  : logger_( n )
{
}
...
stdpmodule::pif_psc_alpha::pif_psc_alpha()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
stdpmodule::pif_psc_alpha::pif_psc_alpha( const pif_psc_alpha& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
stdpmodule::pif_psc_alpha::init_state_( const Node& proto )
{
...
void
stdpmodule::pif_psc_alpha::init_buffers_()
{
...
void
stdpmodule::pif_psc_alpha::calibrate()
{
  B_.logger_.init();
...
void
stdpmodule::pif_psc_alpha::update( Time const& slice_origin,
...
void
stdpmodule::pif_psc_alpha::handle( SpikeEvent& e )
{
...
void
stdpmodule::pif_psc_alpha::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
stdpmodule::pif_psc_alpha::handle( DataLoggingRequest& e )
{
